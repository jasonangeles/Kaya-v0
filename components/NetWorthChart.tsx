...
interface NetWorthChartProps {
  ...
  mode: 'FIAT' | 'BTC' | 'COMPARISON'; // Comparison shows BTC vs USD Erosion
...
export const NetWorthChart: React.FC<NetWorthChartProps> = ({ data, mode, displayCurrency, timeRange }) => {
  ...
  const dataKey = mode === 'BTC' ? 'totalValueBTC' : (displayCurrency === Currency.PHP ? 'totalValuePHP' : 'totalValueUSD');
  const color = mode === 'BTC' ? '#F7931A' : '#10b981'; // Bitcoin Orange or Emerald Green
