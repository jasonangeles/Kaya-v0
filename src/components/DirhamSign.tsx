...
// Currency symbol: the Dirham icon for AED, the text symbol otherwise.
export const Sym: React.FC<{ code: string }> = ({ code }) =>
  code === 'AED' ? <DirhamSign /> : <>{symbolFor(code)}</>;
